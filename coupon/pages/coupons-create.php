        ...
        <form action="../coupon-data/coupons.php" class="w-50 text-start" method="post">
            ...
            <?php foreach ($categories as $category): ?>
              <ul class="nav nav-underline mb-3 ">
                <li class="nav-item ms-2 me-2 p-1">
                  <a href="coupons-create.php?category=<?= $category["id"] ?>" class="nav-link p-2 <?php if (isset($_GET["category"]) && $_GET["category"] == $category["id"]) echo "active" ?>"><?= $category["category"] ?></a>
          ...
          <?php if (isset($_GET["category"])): ?>
            ...
            <div class="mb-4">
              ...
              <button type="submit" class="btn btn-dark mb-2" onclick="sendData()">送出</button>
