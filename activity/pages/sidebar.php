...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 bg-white my-2"
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand px-4 py-3 m-0" href="">
      ...
      <span class="ms-1 fs- fw-light">六弦學院</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link <?= $current_page == 'users.php' ? 'active bg-gradient-dark text-white' : 'text-dark' ?>" href="users.php">
          <i class="material-symbols-rounded opacity-5  me-1">group</i>
          <span class="nav-link-text ms-1">會員管理</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?= $current_page == '' ? 'active bg-gradient-dark text-white' : 'text-dark' ?>" href="">
      ...
      <li class="nav-item">
        <a class="nav-link <?= $current_page == 'activity-index.php' ? 'active bg-gradient-dark text-white' : 'text-dark' ?>" href="activity-index.php">
